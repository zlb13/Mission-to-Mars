...
def scrape_all():
    ...
    # Set up splinter and initiate driver for deployment
...
def mars_facts():
    ...
    try:
        # use ' read_html to scrape the facts table from website into a dataframe
...
def hemisphere_image(browser):
    ...
    # Add try/except for error handling
    try:
        titles = browser.find_by_css('h2.title')
    except AttributeError:
        return None 
